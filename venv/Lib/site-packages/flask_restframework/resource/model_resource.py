...
class CreateMixin:
    ...
    def post(self, request):
        ...
        return jsonify(self.serializer_class(instance).serialize_one())


class RetrieveMixin:
    def get_object(self, request, pk):
        obj = self.get_instance(pk)
        return jsonify(self.serializer_class(obj).serialize_one())
...
class UpdateMixin:
    ...
    def _perform_update(self, pk, request, part=False):
        ...
        return jsonify(self.serializer_class(updatedInstance).serialize_one())
